...
int main(int argc, char *argv[])
{
    ...
    sup.show();
    double* tempbruh;
    tempbruh = sup.on_pushButton_clicked();
    valueSetter(tempbruh);*/
    MainWindow w;
    w.show();
    return a.exec();
}
//перенести ввод с файла и с попапов в мэйн, возможно тогда удастся и вывод нормально оформить
...
//  int Sec = time.second();
  ...
  ui->lineEdit_7->setText(QString::number(galactika->stars[sizeof(galactika->stars)-1]->m));
  ui->lineEdit_6->setText(QString::number(galactika->stars[sizeof(galactika->stars)-1]->x[0]));
  ui->lineEdit_8->setText(QString::number(galactika->stars[sizeof(galactika->stars)-1]->x[1]));
  ui->lineEdit_9->setText(QString::number(galactika->stars[sizeof(galactika->stars)-1]->v[0]));
  ui->lineEdit_10->setText(QString::number(galactika->stars[sizeof(galactika->stars)-1]->v[1]));
  ui->lineEdit_16->setText(QString::number(galactika->stars[sizeof(galactika->stars)-2]->m));
  ui->lineEdit_19->setText(QString::number(galactika->stars[sizeof(galactika->stars)-2]->x[0]));
  ui->lineEdit_17->setText(QString::number(galactika->stars[sizeof(galactika->stars)-2]->x[1]));
  ui->lineEdit_18->setText(QString::number(galactika->stars[sizeof(galactika->stars)-2]->v[0]));
  ui->lineEdit_20->setText(QString::number(galactika->stars[sizeof(galactika->stars)-2]->v[1]));
  ui->lineEdit_11->setText(QString::number(galactika->stars[sizeof(galactika->stars)-3]->m));
  ui->lineEdit_12->setText(QString::number(galactika->stars[sizeof(galactika->stars)-3]->x[0]));
  ui->lineEdit_13->setText(QString::number(galactika->stars[sizeof(galactika->stars)-3]->x[1]));
  ui->lineEdit_14->setText(QString::number(galactika->stars[sizeof(galactika->stars)-3]->v[0]));
  ui->lineEdit_15->setText(QString::number(galactika->stars[sizeof(galactika->stars)-3]->v[1]));
  /*temp=galactika->mass3[2];
  ui->lineEdit_7->setText(QString::number(galactika->stars[temp]->m));
